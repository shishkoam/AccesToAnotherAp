package shishkoam.onemoreapp;
    ...
    public class MainActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            try {
                text.setText(text.getText().toString() + '\n' + "ExtSd: " + getBaseContext().getExternalFilesDir(null).getPath() + getNumberOfFiles(getExternalCacheDir()));
            }catch (NullPointerException e){}

            try {
                text.setText(text.getText().toString() + '\n' + "Ext_Sd: " + getExternalStorageDirectory().getAbsolutePath());
            }catch (NullPointerException e){}

            try {
                text.setText(text.getText().toString() + '\n' + "Real_Ext_Sd_: " +getSecondaryStorage().getAbsolutePath());
            }catch (NullPointerException e){}
            try {
                File anotherDir = new File(getSecondaryStorage().getParent());
                File anotherUpperDir = new File(anotherDir.getParent()+"/shishkoam.myapplication/files");
                text.setText(text.getText().toString() + '\n' + "Another_dir_Real_Ext_Sd_: " + anotherUpperDir.getAbsolutePath());
            }catch (NullPointerException e){}
...
//                        File myFile = new File(getSecondaryStorage().getAbsolutePath() + "/mysdfile.txt");
                        File anotherDir = new File(getSecondaryStorage().getParent());
                        File anotherUpperDir = new File(anotherDir.getParent()+"/shishkoam.myapplication/files");
                        File myFile = new File(anotherUpperDir +"/mysdfile.txt");
